...
main:
		...
		imul    rax, rbx
		mov     qword[rsp + 704], rax     ; Push variable onto stack
		mov     rax, qword[rsp + 696]       ; 64 bit value loading of data values only through rax
		mov     rbx, qword[rsp + 704]
		add     rax, rbx

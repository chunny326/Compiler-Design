...
main:
		...
		mov     rax, qword[rsp + 800]       ; 64 bit value loading of data values only through rax
		mov     rbx, 3
		imul    rax, rbx
		mov     qword[rsp + 808], rax     ; Push variable onto stack
		mov     rax, qword[rsp + 808]       ; 64 bit value loading of data values only through rax
		mov     rbx, 3
		imul    rax, rbx
		...
		mov     rax, qword[rsp + 792]       ; 64 bit value loading of data values only through rax
		...
		mov     qword[rsp + 808], rax     ; Push variable onto stack
		mov     rax, qword[rsp + 752]       ; 64 bit value loading of data values only through rax
		mov     rbx, qword[rsp + 808]
		sub     rax, rbx
		mov     qword[rsp + 816], rax     ; Push variable onto stack
		mov     rax, qword[rsp + 744]       ; 64 bit value loading of data values only through rax
		mov     rbx, qword[rsp + 816]
		sub     rax, rbx
		mov     qword[rsp + 824], rax     ; Push variable onto stack
		mov     rax, qword[rsp + 824]
